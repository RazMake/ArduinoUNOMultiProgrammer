...
So I decided to save my self some grief in the future and:
	- make it a repeatable process to flashing each chip
...
## _Disclaimer_
_There might be better implementations for this but with what I had at my disposal these two adapters are not that bad.
The circuits I have used are minimalistic, and roughly built (no PCBs), but the adapters are relatively small and relatively convenient to use._